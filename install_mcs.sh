...
#Globale Variablen
  ...
  MC_DIR="/home/pi/mcs"
  MC_SERVER__DIR="/home/pi/mcs/mc_server"
...
setup_directories(){
  ...
  sudo cp start-minecraft.sh  $MC_SERVER__DIR
  sudo cp stop-minecraft.sh   $MC_SERVER__DIR
  sudo cp paperupdate.sh   $MC_SERVER__DIR
  ...
  sudo chmod +x $MC_SERVER__DIR/start-minecraft.sh
  sudo chmod +x $MC_SERVER__DIR/stop-minecraft.sh
  sudo chmod +x $MC_SERVER__DIR/paperupdate.sh
...
echo "alias minecraft-console='screen -r minecraft'" >> ~/.bash_aliases
source ~/.bash_aliases
